...
function Intervjuer() {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      const q = query(collection(db, 'articles'), where('category', '==', 'intervjuer'), orderBy('createdAt', 'desc'));
  ...
  return (
    <div className="container mx-auto p-4 pt-20">
      ...
      <main className="pt-20 pb-24 mt-16 min-h-screen">
        <h2 className="text-3xl font-bold mb-6 text-center">Intervjuer</h2>
        <h4 className="text-xl font-semibold mb-4">Siste intervjuer</h4>
